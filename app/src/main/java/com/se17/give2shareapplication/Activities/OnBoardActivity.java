...
public class OnBoardActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        btnLeft.setOnClickListener(v-> {
                //if skip is pressed then we go to page 3
                viewPager.setCurrentItem(viewPager.getCurrentItem()+2);
        });

    }

    //method to create dots with the help of HTML code
    private void addDots(int position){
        ...
        //changing the selected dot color
        if (dots.length > 0){
    ...
    private ViewPager.OnPageChangeListener listner = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            //change NEXT btn to FINISH btn if we reached page 3
            //and hide SKIP btn we are not on page 1
